...
public class rec6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String mostFrequentHistory6Disease = SavedResultsManager.getMostFrequentDiseaseHistory6();
        if (mostFrequentHistory6Disease != null) {
            mostFrequentTextView.setText("Most Frequent Disease in History6: " + mostFrequentHistory6Disease);
        }
    }
